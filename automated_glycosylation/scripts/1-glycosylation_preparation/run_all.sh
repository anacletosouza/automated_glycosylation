...
# Define paths
# -------------------------------
INPUT_PATH="/grain/anacleto/projects/project_2_automatized_glycosylation_in_glycoproteins/S_GLYCOSYLATION/OMICRON/INPUT_DIR"
OUTPUT_PATH="/grain/anacleto/projects/project_2_automatized_glycosylation_in_glycoproteins/S_GLYCOSYLATION/OMICRON/1-GLYCOPROTEIN_PREPARATION"
SCRIPTS_PYTHON="/grain/anacleto/projects/project_2_automatized_glycosylation_in_glycoproteins/S_GLYCOSYLATION/OMICRON/python_scripts/1-glycosylation_preparation"
...
# -------------------------------
INPUT_TSV="$INPUT_PATH/caselino_2020_table_Omicron.tsv"
...
PDB_INPUT_PROTEIN_PREPARED="$INPUT_PATH/spike_Omicron.pdb"
PDB_OUTPUT_PROTEIN_PREPARED_2="$OUTPUT_PATH/PDB_PROTEIN_GLYCOSYLATED/spike_Omicron_asn_orientation.pdb"
