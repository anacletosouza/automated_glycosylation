...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Carbohydrate Composition Analysis")
    parser.add_argument(
        "-p", "--pdb", type=str, default="D_1_parser.pkl",
        help="Path to PDB analysis pickle file (default: D_1_parser.pkl)"
    )
    parser.add_argument(
        "-r", "--rtp", type=str, default="carb_residues.pkl",
        help="Path to RTP residues pickle file (default: carb_residues.pkl)"
    )
